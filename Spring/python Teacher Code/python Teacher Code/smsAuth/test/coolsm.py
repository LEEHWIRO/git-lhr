...
if __name__ == "__main__":
    ...
    api_key = "NCSQABGRTKOKSBSH" 
    api_secret = "CF6C18IJJHFWWHKXJQANBVCGDTXDEXKE"
    ...
    params['to'] = '01040926762'  # 수신자 번호 입력, 다중으로 보내려면 '01012341234, 01043214321' 으로 입력
    params['from'] = '01040926762'  # 발신자 번호 입력, api_key에 할당된 소유자의 번호로 입력해야 성공적으로 진행됨
    params['text'] = '테스트 입니다.'  # 보낼 텍스트

 ...
 * Lock 기능을 제공하는 클래스
 * 
 * ReentrantLock : Read 및 White 구분없이 사용하기 위한 락 클래스로 동기화 처리를 위해 사용됨.
 * => Synchonized를 이용한 동기화 처리보다 부가적인 기능이 제공됨. ex) Fairness 설정 등
 * ReentrantReadWriterLock : Read 및 Write
 */

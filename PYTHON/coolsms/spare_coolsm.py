...
if __name__ == "__main__":
    ...
    api_key = "NCSPEJLJHKNWA9GZ" 
    api_secret = "ZGREUXL0ZJ35LD0U58ROBZJUVFCQPI0X"
    ...
    params['to'] = '01047243957'  # 수신자 번호 입력, 다중으로 보내려면 '01012341234, 01043214321' 으로 입력
    params['from'] = '01047243957'  # 발신자 번호 입력, api_key에 할당된 소유자의 번호로 입력해야 성공적으로 진행됨
    params['text'] = 'Test Message'  # 보낼 텍스트
